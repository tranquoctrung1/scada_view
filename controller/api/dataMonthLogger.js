    ...
    if (site.length > 0) {
        if (site[0].LoggerId != null && site[0].LoggerId != undefined) {
            ...
            for (let i = 0; i < spaceMonth; i++) {
                ...
                obj.MinFlow = null;
                obj.NetIndex = 0;
                obj.MaxPressure = null;
                obj.MinPressure = null;
                ...
                for (let channel of listChannels) {
                    ...
                    if (
                        ...
                        if (maxValue.length > 0) {
                            if (obj.MaxPressure == null) {
                                obj.MaxPressure = maxValue[0].Value.toFixed(2);
                            } else {
                                if (obj.MaxPressure < maxValue[0].Value) {
                                    obj.MaxPressure =
                        ...
                        if (minValue.length > 0) {
                            if (obj.MinPressure == null) {
                                obj.MinPressure = minValue[0].Value.toFixed(2);
                            } else {
                                if (obj.MinPressure > minValue[0].Value) {
                                    obj.MinPressure =
                        ...
                        if (maxValue.length > 0) {
                            if (obj.MaxFlow == null) {
                                ...
                                if (obj.MaxFlow < maxValue[0].Value) {
                                    obj.MaxFlow = maxValue[0].Value.toFixed(2);
                                }
                            }
                        }
                        ...
                        if (minValue.length > 0) {
                            if (obj.MinFlow == null) {
                                ...
                                if (obj.MinFlow > minValue[0].Value) {
                                    obj.MinFlow = minValue[0].Value.toFixed(2);
                                }
                            }
                        }
