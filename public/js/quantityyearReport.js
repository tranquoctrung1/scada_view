...
function fetchSites() {
    axios
        ...
        .then((res) => {
            ...
            startDate.value = start.getFullYear();
            endDate.value = end.getFullYear();

            getDataQuantityYearReport();
        })
...
function getDataQuantityYearReport() {
            ...
            .then((res) => {
                ...
                $('#example').DataTable({
                    ...
                    buttons: [
                        {
                            extend: 'excelHtml5',
                            title: `Bao_Cao_San_Luong_Nam_${siteid}_Tu_${convertDateToStringYearToExportFile(
                                start,
                            )}_Den_${convertDateToStringYearToExportFile(end)}`,
                        },
                        {
                            extend: 'csvHtml5',
                            title: `Bao_Cao_San_Luong_Nam_${siteid}_Tu_${convertDateToStringYearToExportFile(
