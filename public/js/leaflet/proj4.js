!(function (t, s) {
    ...
    function t(t, s) {
        ...
        for (
            var i,
                a = Object.keys(t),
                h = s.toLowerCase().replace(Ot, ''),
                e = -1;
            ++e < a.length;

        )
            if (((i = a[e]), i.toLowerCase().replace(Ot, '') === h))
                return t[i];
    }
    function s(t) {
    ...
    function r(t) {
        ...
        if (
            ...
            for (var i = '', a = 0, h = t.AXIS.length; a < h; ++a) {
                var r = [
                    t.AXIS[a][0].toLowerCase(),
                    t.AXIS[a][1].toLowerCase(),
                ];
                -1 !== r[0].indexOf('north') ||
        ...
        'GEOGCS' === t.type && (o = t),
            o &&
                ...
                o.DATUM &&
                    o.DATUM.TOWGS84 &&
                    (t.datum_params = o.DATUM.TOWGS84),
    ...
    function C(t, s, i) {
        for (var a = [], h = 0; h < s.nSubgrids; h++) {
            var e = S(t, 176, i),
                ...
                r = Math.round(
                    1 +
                        (e.upperLongitude - e.lowerLongitude) /
                            e.longitudeInterval,
                ),
                o = Math.round(
                    1 +
                        (e.upperLatitude - e.lowerLatitude) /
                            e.latitudeInterval,
                );
            a.push({
            ...
            if (h) {
                if (a.datumCode && 'none' !== a.datumCode) {
                    ...
                    e &&
                        ((a.datum_params =
                            a.datum_params ||
                            (e.towgs84 ? e.towgs84.split(',') : null)),
                        (a.ellps = e.ellipse),
    ...
    function G(t, s, i) {
        ...
        for (
            ...
            if (null !== r.grid) {
                var o = r.grid.subgrids[0],
                    l = (Math.abs(o.del[1]) + Math.abs(o.del[0])) / 1e4,
                    u = o.ll[0] - l,
                    c = o.ll[1] - l,
                    M = o.ll[0] + (o.lim[0] - 1) * o.del[0] + l,
                ...
                return (
                    console.log(
                        "Unable to find mandatory grid '" + r.name + "'",
                    ),
                    -1
                );
        }
    ...
    function F(t, s) {
        return (
            ((t.datum.datum_type === ft || t.datum.datum_type === dt) &&
                'WGS84' !== s.datumCode) ||
            ((s.datum.datum_type === ft || s.datum.datum_type === dt) &&
                'WGS84' !== t.datumCode)
        );
    }
    function D(t, s, i, a) {
    ...
    function et(t, s) {
        ...
        for (
            var i = us.charCodeAt(s - 1), a = 0, h = !1;
            i !== t.charCodeAt(0);
    ...
    function ut(t, s, i, a) {
        ...
        return (
            t < wt
                ? ((a.value = Ai.AREA_0), (h = 0))
                : ((h = Math.atan2(s, i)),
                  Math.abs(h) <= Nt
                      ? (a.value = Ai.AREA_0)
                      : h > Nt && h <= xt + Nt
                      ? ((a.value = Ai.AREA_1), (h -= xt))
                      : h > xt + Nt || h <= -(xt + Nt)
                      ? ((a.value = Ai.AREA_2), (h = h >= 0 ? h - Pt : h + Pt))
                      : ((a.value = Ai.AREA_3), (h += xt))),
            h
        );
    }
    function ct(t, s) {
    ...
    var as = function (t, s, i) {
            ...
            return (
                s.datum_type === pt &&
                    ((e = 6378137),
                    (n = 6356752.314),
                    (r = 0.0066943799901413165)),
                h !== r || a !== e || T(t.datum_type) || T(s.datum_type)
                    ? ((i = k(i, h, a)),
                      T(t.datum_type) &&
                          (i = R(i, t.datum_type, t.datum_params)),
                      T(s.datum_type) &&
                          (i = L(i, s.datum_type, s.datum_params)),
                      (i = q(i, r, e, n)),
                      s.datum_type !== pt || 0 === G(s, !0, i) ? i : void 0)
                    : i
            );
        },
        hs = function (t, s, i) {
    ...
    var ys = 0.01068115234375,
        _s = function (t) {
            var s = [];
            (s[0] =
                1 - t * (0.25 + t * (0.046875 + t * (0.01953125 + t * ys)))),
                (s[1] =
                    t * (0.75 - t * (0.046875 + t * (0.01953125 + t * ys))));
            var i = t * t;
            return (
                (s[2] =
                    i *
        ...
        Os = function (t, s) {
            if (void 0 === t) {
                if (
                    (t = Math.floor((30 * (Ht(s) + Math.PI)) / Math.PI) + 1) < 0
                )
                    return 0;
                if (t > 60) return 60;
            }
        ...
        Ls = {
            init: function () {
                ...
                (s *= s),
                    ...
                    (this.K =
                        Math.tan(0.5 * this.phic0 + Nt) /
                        (Math.pow(Math.tan(0.5 * this.lat0 + Nt), this.C) *
                ...
                return (
                    (t.y =
                        2 *
                            Math.atan(
                                this.K *
                                    Math.pow(Math.tan(0.5 * i + Nt), this.C) *
            ...
            inverse: function (t) {
                for (
                    ...
                    ((i =
                        2 *
                            Math.atan(
                                a * qs(this.e * Math.sin(t.y), -0.5 * this.e),
                            ) -
                        xt),
                ...
                (this.coslat0 = Math.cos(this.lat0)),
                    ...
                    this.sphere
                        ? 1 === this.k0 &&
                          ...
                          (this.k0 =
                              0.5 * (1 + Wt(this.lat0) * Math.sin(this.lat_ts)))
                        : (Math.abs(this.coslat0) <= wt &&
                              (this.lat0 > 0
                                  ? (this.con = 1)
                                  : (this.con = -1)),
            ...
            inverse: function (t) {
                ...
                if (Math.abs(this.coslat0) <= wt) {
                    ...
                    (h =
                        ...
                        (i = -1 * Jt(this.e, Math.tan(0.5 * (xt + e))));
        ...
        zs = {
            init: function () {
                ...
                if (
                    ...
                    _ && (y = this.alpha),
                    x && (c = this.rectified_grid_angle * At),
                    _ || x)
                )
                    M = this.longc;
                else if (
                ...
                (s = Math.sqrt(g)),
                    Math.abs(this.lat0) > wt
                        ? ((r = Math.sin(this.lat0)),
                          ...
                          (this.B = i * i),
                          (this.B = Math.sqrt(
                              1 + (this.es * this.B * this.B) / g,
                          )),
                          (this.A = (this.B * this.k0 * s) / t),
                          (h =
                              (a = (this.B * s) / (i * Math.sqrt(t))) * a -
                              1) <= 0
                              ? (h = 0)
                              : ((h = Math.sqrt(h)), this.lat0 < 0 && (h = -h)),
                          (this.E = h += a),
                          (this.E *= Math.pow(
                              Xt(this.e, this.lat0, r),
                              this.B,
                          )))
                        : ((this.B = 1 / s),
                          (this.A = this.k0),
                    ...
                    _ || x
                        ? (_
                          ...
                          (this.lam0 =
                              M -
                              Math.asin(0.5 * (h - 1 / h) * Math.tan(u)) /
                                  this.B))
                        : ((e = Math.pow(Xt(this.e, p, Math.sin(p)), this.B)),
                          ...
                          (this.lam0 = Ht(
                              0.5 * (f + d) -
                                  Math.atan(
                                      (l * Math.tan(0.5 * this.B * (f - d))) /
                                          o,
                                  ) /
                                      this.B,
                          )),
                          (u = Math.atan(
                              (2 * Math.sin(this.B * Ht(f - this.lam0))) /
                                  (h - 1 / h),
                          )),
                    ...
                    this.no_off
                        ...
                        : ((this.u_0 = Math.abs(
                              this.ArB *
                                  Math.atan(Math.sqrt(a * a - 1) / Math.cos(y)),
                          )),
                          this.lat0 < 0 && (this.u_0 = -this.u_0)),
                    (h = 0.5 * u),
                    (this.v_pole_n = this.ArB * Math.log(Math.tan(Nt - h))),
                    (this.v_pole_s = this.ArB * Math.log(Math.tan(Nt + h)));
            },
            forward: function (t) {
                var s,
                    i,
                    ...
                    l = {};
                if (
                    ((t.x = t.x - this.lam0), Math.abs(Math.abs(t.y) - xt) > wt)
                ) {
                    if (
                        ((e =
                            this.E /
                            Math.pow(Xt(this.e, t.y, Math.sin(t.y)), this.B)),
                        (n = 1 / e),
                        (s = 0.5 * (e - n)),
                        (i = 0.5 * (e + n)),
                    ...
                    (o = 0.5 * this.ArB * Math.log((1 - a) / (1 + a))),
                        ...
                        (r =
                            Math.abs(n) < Bs
                                ...
                                : this.ArB *
                                  Math.atan2(
                                      s * this.cosgam + h * this.singam,
                                      n,
                                  ));
                } else
                    (o = t.y > 0 ? this.v_pole_n : this.v_pole_s),
                        (r = this.ArB * t.y);
                return (
                    this.no_rot
                        ? ((l.x = r), (l.y = o))
            ...
            inverse: function (t) {
                ...
                if (
                    ...
                    if (
                        ...
                        (o.y = Jt(this.e, Math.pow(o.y, 1 / this.B))),
                        o.y === 1 / 0)
                    )
                        throw new Error();
                    o.x =
        ...
        Fs = {
            ...
            inverse: function (t) {
                ...
                return (
                    (e = Ht(o / this.ns + this.long0)), (t.x = e), (t.y = h), t
                );
            },
            names: [
        ...
        Zs = {
            ...
            inverse: function (t) {
                ...
                if (this.sphere) {
                    ...
                    var o = Js(this.a, this.e, Math.sin(r)),
            ...
            inverse: function (t) {
                ...
                if (this.sphere) {
                    var u,
                        c = 0,
                        M = 0;
                    if (((u = Math.sqrt(o * o + l * l)), (i = 0.5 * u) > 1))
                        return null;
                    switch (
                        ((i = 2 * Math.asin(i)),
                        (this.mode !== this.OBLIQ &&
                        ...
                        case this.EQUIT:
                            (i =
                                Math.abs(u) <= wt ? 0 : Math.asin((l * M) / u)),
                                (o *= M),
                                (l = c * u);
                            break;
                        case this.OBLIQ:
        ...
        ri = {
            init: function () {
                Math.abs(this.lat1 + this.lat2) < wt ||
                    ...
                    (this.qs1 = Ys(this.e3, this.sin_po, this.cos_po)),
                    (this.sin_po = Math.sin(this.lat2)),
                    (this.cos_po = Math.cos(this.lat2)),
                    (this.t2 = this.sin_po),
                    (this.ms2 = Qt(this.e3, this.sin_po, this.cos_po)),
                    (this.qs2 = Ys(this.e3, this.sin_po, this.cos_po)),
                    (this.sin_po = Math.sin(this.lat0)),
                    (this.cos_po = Math.cos(this.lat0)),
                    (this.t3 = this.sin_po),
                    (this.qs0 = Ys(this.e3, this.sin_po, this.cos_po)),
                    Math.abs(this.lat1 - this.lat2) > wt
                        ? (this.ns0 =
            ...
            forward: function (t) {
                ...
                var a = Ys(this.e3, this.sin_phi, this.cos_phi),
        ...
        ci = {
            ...
            inverse: function (t) {
                ...
                return (
                    ...
                    (t.y = Ks(this.lat0 + (i - this.y0) / this.a)),
                    t
                );
            },
                ...
                for (var M = 0; M < this.iterations; M++) {
                    ...
                    for (s = 2; s <= 6; s++)
                        (f = p * u + d * c),
                            ...
                            (m +=
                                (s - 1) *
                                (this.B_re[s] * d - this.B_im[s] * p)),
                            (y +=
                                (s - 1) *
                                (this.B_im[s] * d + this.B_re[s] * p));
                    (d = 1), (p = 0);
                    var _ = this.B_re[1],
                        x = this.B_im[1];
                    for (s = 2; s <= 6; s++)
                    ...
                    : ((s = Qs(this.es)),
                      ...
                      Math.abs(this.sin_p12 - 1) <= wt
                          ...
                          ? ((e = this.a * Us(s, i, a, h, xt)),
                            ...
                            t)
                          : ((r = N / C),
                            (o = Js(this.a, this.e, this.sin_p12)),
                            (l = Js(this.a, this.e, N)),
                            (u = Math.atan(
                                (1 - this.es) * r +
                                    (this.es * o * this.sin_p12) / (l * C),
                            )),
                            (c = Math.atan2(
                                Math.sin(P),
                                this.cos_p12 * Math.tan(u) -
                                    this.sin_p12 * Math.cos(P),
                            )),
                            (x =
                                0 === c
                                    ? Math.asin(
                ...
                return (
                    ...
                    Math.abs(this.sin_p12 - 1) <= wt
                        ...
                        : ((s = Math.sqrt(t.x * t.x + t.y * t.y)),
                          ...
                          (d = Js(this.a, this.e, this.sin_p12)),
                          (y = Math.cos(m)),
                          ...
                          (e = Ht(
                              this.long0 +
                                  Math.asin(
                                      (Math.sin(m) * Math.sin(b)) / Math.cos(p),
                                  ),
                          )),
                          (A = Math.sin(p)),
                          (n = Math.atan2(
        ...
        Ai = { AREA_0: 1, AREA_1: 2, AREA_2: 3, AREA_3: 4 },
        Ei = {
            init: function () {
                (this.x0 = this.x0 || 0),
                    (this.y0 = this.y0 || 0),
                    ...
                    this.lat0 >= xt - Nt / 2
                        ...
                        : this.lat0 <= -(xt - Nt / 2)
                        ? (this.face = wi.BOTTOM)
                        : Math.abs(this.long0) <= Nt
                        ? (this.face = wi.FRONT)
                        : Math.abs(this.long0) <= xt + Nt
            ...
            forward: function (t) {
                ...
                if (
                    ...
                    (h = xt - s),
                        i >= Nt && i <= xt + Nt
                            ? ((o.value = Ai.AREA_0), (a = i - xt))
                            : i > xt + Nt || i <= -(xt + Nt)
                            ? ((o.value = Ai.AREA_1),
                              (a = i > 0 ? i - Pt : i + Pt))
                            : i > -(xt + Nt) && i <= -Nt
                            ? ((o.value = Ai.AREA_2), (a = i + xt))
                            : ((o.value = Ai.AREA_3), (a = i));
                else if (this.face === wi.BOTTOM)
                    (h = xt + s),
                        i >= Nt && i <= xt + Nt
                            ? ((o.value = Ai.AREA_0), (a = -i + xt))
                            : i < Nt && i >= -Nt
                            ? ((o.value = Ai.AREA_1), (a = -i))
                            : i < -Nt && i >= -(xt + Nt)
                            ? ((o.value = Ai.AREA_2), (a = -i - xt))
                            : ((o.value = Ai.AREA_3),
                              (a = i > 0 ? -i + Pt : -i - Pt));
                    ...
                    this.face === wi.RIGHT
                        ...
                        this.face === wi.FRONT
                            ...
                            : this.face === wi.LEFT
                            ? (a = ut((h = Math.acos(-u)), c, l, o))
                            : ((h = a = 0), (o.value = Ai.AREA_0));
                }
                return (
                    (n = Math.atan(
                        (12 / Pt) *
                            (a + Math.acos(Math.sin(a) * Math.cos(Nt)) - xt),
                    )),
                    (e = Math.sqrt(
                        (1 - Math.cos(h)) /
            ...
            inverse: function (t) {
                ...
                if (
                    ...
                    t.x >= 0 && t.x >= Math.abs(t.y)
                        ...
                        ? ((c.value = Ai.AREA_1), (s -= xt))
                        : t.x < 0 && -t.x >= Math.abs(t.y)
                        ? ((c.value = Ai.AREA_2), (s = s < 0 ? s + Pt : s - Pt))
                        : ((c.value = Ai.AREA_3), (s += xt)),
                    (l = (Pt / 12) * Math.tan(s)),
                ...
                if (0 !== this.es) {
                    ...
                    (p = u.phi < 0 ? 1 : 0),
                        ...
                        (y =
                            this.b /
                            Math.sqrt(m * m + this.one_minus_f_squared)),
                        (u.phi = Math.atan(
        ...
        Li = {
            ...
            inverse: function (t) {
                ...
                if (s.y >= 1) (s.x /= Ni[ki][0]), (s.y = t.y < 0 ? -xt : xt);
                else {
            ...
            init: function () {
                if (
                    ...
                    Math.abs(Math.abs(this.lat0) - xt) < wt
                        ? (this.mode = this.lat0 < 0 ? Gi.S_POLE : Gi.N_POLE)
                        : Math.abs(this.lat0) < wt
                        ? (this.mode = Gi.EQUIT)
                        : ((this.mode = Gi.OBLIQ),
                          (this.sinph0 = Math.sin(this.lat0)),
            ...
            inverse: function (t) {
                ...
                if (Math.abs(e) < wt) (h.x = 0), (h.y = t.y);
                    ...
                    switch (
                        ...
                        (r =
                            (this.p - Math.sqrt(r)) /
                            (this.pn1 / e + e / this.pn1)),
                        (n = Math.sqrt(1 - r * r)),
                        this.mode)
                    ) {
                        case Gi.OBLIQ:
                            (h.y = Math.asin(
                                n * this.sinph0 + (t.y * r * this.cosph0) / e,
                            )),
                                (t.y = (n - this.sinph0 * Math.sin(h.y)) * e),
                                (t.x *= r * this.cosph0);
                            break;
                        case Gi.EQUIT:
                            (h.y = Math.asin((t.y * r) / e)),
                                (t.y = n * e),
                                (t.x *= r);
                            break;
                        case Gi.N_POLE:
