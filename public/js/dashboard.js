...
function fetchSites() {
    axios
        ...
        .then((res) => {
            ...
            getValueForDay(selectSite.value);
            getDataForDay(selectSite.value);
            getValueForMonth(selectSite.value);
            getDataForMonth(selectSite.value);
            getValueForYear(selectSite.value);
            getDataForYear(selectSite.value);
        })
...
inputSelectSite.addEventListener('change', function (e) {
...
function getValueForDay(siteid) {
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                valuePrevDay.innerHTML = ConvertDataIntoTable(
                    res.data[0].Value,
                );
            }
        })
...
function getValueForMonth(siteid) {
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                valueThisMonth.innerHTML = ConvertDataIntoTable(
                    res.data[0].Value,
                );
            }
        })
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                valuePrevMonth.innerHTML = ConvertDataIntoTable(
                    res.data[0].Value,
                );
            }
        })
...
function getValueForYear(siteid) {
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                valueThisYear.innerHTML = ConvertDataIntoTable(
                    res.data[0].Value,
                );
            }
        })
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                valuePrevYear.innerHTML = ConvertDataIntoTable(
                    res.data[0].Value,
                );
            }
        })
...
function getDataForDay(siteid) {
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                titleChartDay.innerHTML = `Biều đồ hàng giờ của ngày  ${
...
function getDataForMonth(siteid) {
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                titleChartMonth.innerHTML = `Biều đồ hàng ngày của tháng ${
                    now.getMonth() + 1 < 10
                        ? `0${now.getMonth() + 1}`
                        : now.getMonth() + 1
                }`;
...
function getDataForYear(siteid) {
    ...
    axios
        ...
        .then((res) => {
            if (CheckExistsData(res.data)) {
                titleChartYear.innerHTML = `Biểu đồ hàng tháng của năm ${now.getFullYear()}`;
        ...
        if (
            ...
            if (item.Value != null && item.Value != undefined) {
                ...
                if (type == 'hour') {
                    ...
                    obj.TimeStamp = convertDateFromApi(item.TimeStamp);
                    obj.TimeStamp = `${obj.TimeStamp.getMonth() + 1}`;
                }
